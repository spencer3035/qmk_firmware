...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 MT(MOD_LGUI, KC_TAB), MT(KC_LALT, KC_A), KC_S,   KC_D,   KC_F,   KC_G,                   KC_H,   KC_J,   KC_K,   KC_L,   MT(MOD_RALT, KC_SCLN),MT(MOD_RGUI, KC_QUOTE),
...
|`KC_KP_ENTER`      |`KC_PENT`|Keypad Ent100 13619  100 13619    0     0  60171      0 --:--:-- --:--:-- --:--:-- 60261
er                  |
