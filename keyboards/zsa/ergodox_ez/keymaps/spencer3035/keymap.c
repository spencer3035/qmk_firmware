...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_LEFT_GUI,    MT(MOD_LALT, KC_A),KC_S,           LT(3,KC_D),     LT(2,KC_F),     LT(4,KC_G),                                                                     KC_H,           KC_J,           KC_K,           KC_L,           MT(MOD_RALT, KC_SCLN),KC_QUOTE,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_ESCAPE,                                                                                                      KC_TAB,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    MT(MOD_LSFT, KC_SPACE),MT(MOD_LGUI, KC_BSPC),QK_AREP,          QK_REP,          MT(MOD_RGUI, KC_ESCAPE),MT(MOD_RSFT, KC_ENTER)
  ),
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_A,           KC_TRANSPARENT, KC_D,           KC_F,           KC_G,                                                                           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_SCLN,        KC_TRANSPARENT,
